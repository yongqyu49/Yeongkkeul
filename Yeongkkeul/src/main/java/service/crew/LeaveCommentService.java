...
public class LeaveCommentService implements CommandProcess {

	@Override
	public String requestProc(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("LeaveComment Service");
        ...
        // 데이터베이스 업데이트 (좋아요 기능)
        int result = cd.leaveComment(email, writer, movie_code); // 구현해야 할 메서드
