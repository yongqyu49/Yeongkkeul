				...
				<div class="modal_box">
					<div class="">
						<div class="modal_ul_container" style="margin: 0px 20px;">
							<ul>
								<li>
									<div class="modal_list" id="change_profile">
										<div class="modal_content">프로필 사진 변경</div>
										<div></div>
									</div>
								</li>
								<li>
						...
						<div class="change_profile_modal" style="margin: 0px 20px; display: none;">
							<section class="setting_section">
								<form name="writeFrm" method="post" action="${pageContext.request.contextPath}/view/movie/changeProfile.do" enctype="multipart/form-data">
									<div class="section_cate">프로필 이미지 변경</div>
									<ul class="">
										<li>
											<div class="modal_list">
												<input class="input" type="file" name="profile" placeholder="프로필 이미지">
												<div></div>
											</div>
										</li>
										<li>
											<div class="modal_list">
												<input class="input" type="file" name="background" placeholder="배경 이미지">
												<div></div>
											</div>
										</li>
										<li>
											<input type="submit" value="변경하기" class="primary-btn order-submit" id="change_profile_submit"/>
										</li>
									</ul>
								</form>
							</section>
